    ...
    <>
      <div className="w-full bg-[#f9f9f7]">
        <div className="container mx-auto mt-10 px-40 py-12 flex flex-col lg:flex-row items-center lg:items-start  ">
          ...
          <div className="md:w-1/2 pl-32 py-16 mt-10 flex justify-center align-middle flex-col text-start">
            <h1 className="text-5xl  mb-6">We provide healthy food for your family.</h1>
